      ...
      var onTemplateData = function(err, data) {
        if(!err) {
          ...
          */
                    ...
                    whatToRender.forEach(function(chunk) {
                      if (typeof chunk == 'function') {
                        ...
                        chunk(renderTemplate.renderVars, function(answer) {
                          ...
                          if(typeof answer == 'string' || answer.toString() == answer) {
                            //console.log('got a string', chunk.indentation, answer);
                            if (!renderTemplate.nowhiteSpace) answer = utils.getText(answer.toString(), chunk.indentation);
                          } else {
                            answer = [function(){
          ...
          console.log('compiled', sTemplateFile, compileCache[sTemplateFile].srcList);
